...
//         vm.prank(lrtSquared.governor());
//         lrtSquared.registerToken(newToken, tokenPositionWeightLimit);
...
//         vm.prank(lrtSquared.governor());
//         lrtSquared.setDepositors(depositors, shouldWhitelist);
//     }
...
//         uint256 aliceBalBefore = lrtSquared.balanceOf(alice);

//         vm.startPrank(alice);
//         IERC20(newToken).forceApprove(address(lrtSquared), amountToDeposit);
//         lrtSquared.deposit(tokens, amounts, alice);
//         vm.stopPrank();

//         uint256 aliceBalAfter = lrtSquared.balanceOf(alice);
